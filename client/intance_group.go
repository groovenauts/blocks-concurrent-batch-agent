...
// create
func (c *Client) CreateIntanceGroup(ctx context.Context, path string, payload *InstanceGroupPayload, orgID string, contentType string) (*http.Response, error) {
	req, err := c.NewCreateIntanceGroupRequest(ctx, path, payload, orgID, contentType)
	if err != nil {
		return nil, err
	}
...
func (c *Client) NewCreateIntanceGroupRequest(ctx context.Context, path string, payload *InstanceGroupPayload, orgID string, contentType string) (*http.Request, error) {
