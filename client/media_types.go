...
// auth (default view)
//
// Identifier: application/vnd.auth-secret+json; view=default
...
// Validate validates the AuthSecret media type instance.
func (mt *AuthSecret) Validate() (err error) {
	if mt.ID == "" {
		err = goa.MergeErrors(err, goa.MissingAttributeError(`response`, "id"))
	}
	return
...
// DecodeAuthSecret decodes the AuthSecret instance encoded in resp body.
func (c *Client) DecodeAuthSecret(resp *http.Response) (*AuthSecret, error) {
	var decoded AuthSecret
	err := c.Decoder.Decode(&decoded, resp.Body, resp.Header.Get("Content-Type"))
	return &decoded, err
}

// AuthCollection is the media type for an array of Auth (default view)
//
// Identifier: application/vnd.auth+json; type=collection; view=default
type AuthCollection []*Auth

// Validate validates the AuthCollection media type instance.
func (mt AuthCollection) Validate() (err error) {
	for _, e := range mt {
		if e != nil {
...
// DecodeAuthCollection decodes the AuthCollection instance encoded in resp body.
func (c *Client) DecodeAuthCollection(resp *http.Response) (AuthCollection, error) {
	var decoded AuthCollection
	err := c.Decoder.Decode(&decoded, resp.Body, resp.Header.Get("Content-Type"))
	return decoded, err
}
...
//
// Identifier: application/vnd.organization+json; view=default
type Organization struct {
	...
	ID string `form:"id" json:"id" yaml:"id" xml:"id"`
	// Memo
	Memo string `form:"memo" json:"memo" yaml:"memo" xml:"memo"`
	// Name
	Name string `form:"name" json:"name" yaml:"name" xml:"name"`
	// Token Amount
	TokenAmount int `form:"token_amount" json:"token_amount" yaml:"token_amount" xml:"token_amount"`
	// Datetime updated
	UpdatedAt *time.Time `form:"updated_at,omitempty" json:"updated_at,omitempty" yaml:"updated_at,omitempty" xml:"updated_at,omitempty"`
}

// Validate validates the Organization media type instance.
func (mt *Organization) Validate() (err error) {
	if mt.ID == "" {
		err = goa.MergeErrors(err, goa.MissingAttributeError(`response`, "id"))
	}
	if mt.Name == "" {
	...
	if mt.Memo == "" {
		err = goa.MergeErrors(err, goa.MissingAttributeError(`response`, "memo"))
	}

	return
}

// DecodeOrganization decodes the Organization instance encoded in resp body.
func (c *Client) DecodeOrganization(resp *http.Response) (*Organization, error) {
	var decoded Organization
	err := c.Decoder.Decode(&decoded, resp.Body, resp.Header.Get("Content-Type"))
	return &decoded, err
}

// OrganizationCollection is the media type for an array of Organization (default view)
//
// Identifier: application/vnd.organization+json; type=collection; view=default
type OrganizationCollection []*Organization

// Validate validates the OrganizationCollection media type instance.
func (mt OrganizationCollection) Validate() (err error) {
	for _, e := range mt {
		if e != nil {
			if err2 := e.Validate(); err2 != nil {
				err = goa.MergeErrors(err, err2)
...
// DecodeOrganizationCollection decodes the OrganizationCollection instance encoded in resp body.
func (c *Client) DecodeOrganizationCollection(resp *http.Response) (OrganizationCollection, error) {
	var decoded OrganizationCollection
	err := c.Decoder.Decode(&decoded, resp.Body, resp.Header.Get("Content-Type"))
	return decoded, err
}
