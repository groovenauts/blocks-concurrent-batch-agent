...
// CloudAsyncOperation (default view)
//
// Identifier: application/vnd.cloud-async-operation+json; view=default
...
// Validate validates the CloudAsyncOperation media type instance.
func (mt *CloudAsyncOperation) Validate() (err error) {
	if mt.ID == "" {
...
// DecodeCloudAsyncOperation decodes the CloudAsyncOperation instance encoded in resp body.
func (c *Client) DecodeCloudAsyncOperation(resp *http.Response) (*CloudAsyncOperation, error) {
	var decoded CloudAsyncOperation
