...
// organizationPayload user type.
type organizationPayload struct {
	// Memo
	Memo *string `form:"memo,omitempty" json:"memo,omitempty" yaml:"memo,omitempty" xml:"memo,omitempty"`
	// Name
	Name *string `form:"name,omitempty" json:"name,omitempty" yaml:"name,omitempty" xml:"name,omitempty"`
	// Token Amount
	TokenAmount *int `form:"token_amount,omitempty" json:"token_amount,omitempty" yaml:"token_amount,omitempty" xml:"token_amount,omitempty"`
}

// Finalize sets the default values for organizationPayload type instance.
func (ut *organizationPayload) Finalize() {
	var defaultTokenAmount = 100
	if ut.TokenAmount == nil {
		ut.TokenAmount = &defaultTokenAmount
	}
}

// Publicize creates OrganizationPayload from organizationPayload
func (ut *organizationPayload) Publicize() *OrganizationPayload {
	var pub OrganizationPayload
	if ut.Memo != nil {
		pub.Memo = ut.Memo
	}
	if ut.Name != nil {
