...
type (
	// CreateAuthCommand is the command line data structure for the create action of Auth
	CreateAuthCommand struct {
		ID          string
		OrgID       string
		PrettyPrint bool
	}

	// DeleteAuthCommand is the command line data structure for the delete action of Auth
	DeleteAuthCommand struct {
		AuthID string
		// ID
		ID          string
		OrgID       string
	...
	// ListAuthCommand is the command line data structure for the list action of Auth
	ListAuthCommand struct {
		ID          string
		OrgID       string
		PrettyPrint bool
	}

	// RefreshInstanceGroupConstructingTaskCommand is the command line data structure for the refresh action of InstanceGroupConstructingTask
	RefreshInstanceGroupConstructingTaskCommand struct {
		// ID
		ID          string
		PrettyPrint bool
	}
	...
	// DeleteOrganizationCommand is the command line data structure for the delete action of Organization
	DeleteOrganizationCommand struct {
		// ID
		ID          string
		PrettyPrint bool
	}
	...
	// ShowOrganizationCommand is the command line data structure for the show action of Organization
	ShowOrganizationCommand struct {
		// ID
		ID          string
		PrettyPrint bool
	}
	...
	// RefreshPipelineBaseClosingTaskCommand is the command line data structure for the refresh action of PipelineBaseClosingTask
	RefreshPipelineBaseClosingTaskCommand struct {
		// ID
		ID          string
		PrettyPrint bool
	}
...
func RegisterCommands(app *cobra.Command, c *client.Client) {
	...
	tmp3 := new(CreateAuthCommand)
	sub = &cobra.Command{
		Use:   `auth ["/admin/organizations/ID/auths"]`,
		Short: ``,
	...
	command.AddCommand(sub)
	tmp4 := new(CreateIntanceGroupCommand)
	sub = &cobra.Command{
...

{
   ...
   "deployment_name": "Mollitia voluptatibus.",
   "gpu_accelerators": {
      "count": 2,
   ...
   "startup_script": "Nesciunt ab perspiciatis.",
   "token_consumption": 2,
   "zone": "us-central1-f"
}`,
...
{
   "id_by_client": "Modi enim.",
   "message": {
      "attributes": {
         "Enim eum aliquam eaque repellendus consequuntur dignissimos.": "Delectus cum veritatis."
      },
      "data": "Odio numquam culpa non aut."
   }
}`,
	...
	command.AddCommand(sub)
	tmp6 := new(CreateOrganizationCommand)
	sub = &cobra.Command{
		Use:   `organization ["/admin/organizations"]`,
		Short: ``,
		Long: `
...
{
   "memo": "Quam sapiente sapiente fugit enim necessitatibus.",
   "name": "org1",
   "token_amount": 10
}`,
	...
	command.AddCommand(sub)
	tmp7 := new(CreatePipelineCommand)
	sub = &cobra.Command{
...

{
   "base": {
      "container": {
         ...
         "name": "Optio et voluptas quia.",
         "options": "--restart=on-failure:3",
         "size": 2,
         "stackdriver_agent": false
      },
      "hibernation_delay": 9030230439708588371,
      "instance_group": {
         "boot_disk": {
            "disk_size_gb": 50,
            "disk_type": "projects/dummy-proj-999/zones/asia-east1-a/diskTypes/pd-standard",
         ...
         "deployment_name": "Rem repellendus vel sit velit voluptatem quidem.",
         "gpu_accelerators": {
            "count": 2,
            "type": "nvidia-tesla-p100"
         },
         ...
         "preemptible": true,
         "project_id": "dummy-proj-999",
         "startup_script": "Maiores consequatur culpa.",
         "token_consumption": 2,
         "zone": "us-central1-f"
      }
   },
   "name": "pipeline1"
	...
	command.AddCommand(sub)
	tmp8 := new(CreatePipelineBaseCommand)
	sub = &cobra.Command{
...

{
   ...
   "hibernation_delay": 7044847696412245341,
   "instance_group": {
      "boot_disk": {
         "disk_size_gb": 50,
         "disk_type": "projects/dummy-proj-999/zones/asia-east1-a/diskTypes/pd-standard",
   ...
   "name": "pipeline1-123"
	...
	tmp9 := new(CurrentPipelineCommand)
	sub = &cobra.Command{
	...
	tmp10 := new(DeleteAuthCommand)
	sub = &cobra.Command{
		Use:   `auth ["/admin/organizations/ID/auths/AUTH_ID"]`,
		Short: ``,
	...
	command.AddCommand(sub)
	tmp11 := new(DeleteIntanceGroupCommand)
	sub = &cobra.Command{
	...
	command.AddCommand(sub)
	tmp13 := new(DeleteOrganizationCommand)
	sub = &cobra.Command{
		Use:   `organization ["/admin/organizations/ID"]`,
		Short: ``,
	...
	command.AddCommand(sub)
	tmp14 := new(DeletePipelineCommand)
	sub = &cobra.Command{
	...
	command.AddCommand(sub)
	tmp15 := new(DeletePipelineBaseCommand)
	sub = &cobra.Command{
		Use:   `pipeline-base ["/pipeline_bases/ID"]`,
		Short: ``,
	...
	tmp16 := new(DestructIntanceGroupCommand)
	sub = &cobra.Command{
	...
	tmp17 := new(HibernationCheckingFinalizeTaskPipelineBaseCommand)
	sub = &cobra.Command{
	...
	tmp18 := new(HibernationGoingFinalizeTaskPipelineBaseCommand)
	sub = &cobra.Command{
	...
	tmp19 := new(InactivateJobCommand)
	sub = &cobra.Command{
	...
	command.AddCommand(sub)
	tmp21 := new(ListIntanceGroupCommand)
	sub = &cobra.Command{
		Use:   `intance-group ["/instance_groups"]`,
		Short: ``,
	...
	command.AddCommand(sub)
	tmp24 := new(ListPipelineBaseCommand)
	sub = &cobra.Command{
		Use:   `pipeline-base ["/pipeline_bases"]`,
		Short: ``,
	...
	tmp25 := new(PreparingFinalizeTaskPipelineCommand)
	sub = &cobra.Command{
	...
	tmp26 := new(PublishingTaskJobCommand)
	sub = &cobra.Command{
	...
	tmp27 := new(PullTaskPipelineBaseCommand)
	sub = &cobra.Command{
	...
	tmp28 := new(RefreshInstanceGroupConstructingTaskCommand)
	sub = &cobra.Command{
	...
	command.AddCommand(sub)
	tmp29 := new(RefreshInstanceGroupDestructingTaskCommand)
	sub = &cobra.Command{
	...
	command.AddCommand(sub)
	tmp30 := new(RefreshInstanceGroupResizingTaskCommand)
	sub = &cobra.Command{
	...
	command.AddCommand(sub)
	tmp31 := new(RefreshPipelineBaseClosingTaskCommand)
	sub = &cobra.Command{
	...
	command.AddCommand(sub)
	tmp32 := new(RefreshPipelineBaseOpeningTaskCommand)
	sub = &cobra.Command{
	...
	tmp33 := new(ResizeIntanceGroupCommand)
	sub = &cobra.Command{
...

{
   "new_size": 6394932039073837583
	...
	tmp34 := new(ShowIntanceGroupCommand)
	sub = &cobra.Command{
		Use:   `intance-group ["/instance_groups/ID"]`,
		Short: ``,
	...
	command.AddCommand(sub)
	tmp36 := new(ShowOrganizationCommand)
	sub = &cobra.Command{
		Use:   `organization ["/admin/organizations/ID"]`,
		Short: ``,
	...
	command.AddCommand(sub)
	tmp38 := new(ShowPipelineBaseCommand)
	sub = &cobra.Command{
		Use:   `pipeline-base ["/pipeline_bases/ID"]`,
		Short: ``,
	...
	tmp39 := new(StartInstanceGroupConstructingTaskCommand)
	sub = &cobra.Command{
...
{
   "finalize_task_path": "Ducimus aspernatur perspiciatis aperiam.",
   "name": "instancegroup-ope1",
   "operation_type": "Accusamus a perferendis itaque corporis voluptatem.",
   "owner_id": "bd2d5ee3-d8be-4024-85a7-334dee9c1c88",
   "owner_type": "InstanceGroup",
   "project_id": "dummy-proj-999",
   "service": "deploymentmanager",
   "status": "Sint hic est sit qui non.",
   "zone": "us-central1-f"
}`,
	...
	command.AddCommand(sub)
	tmp40 := new(StartInstanceGroupDestructingTaskCommand)
	sub = &cobra.Command{
...

{
   ...
   "zone": "us-central1-f"
	...
	command.AddCommand(sub)
	tmp41 := new(StartInstanceGroupResizingTaskCommand)
	sub = &cobra.Command{
...

{
   ...
   "zone": "us-central1-f"
	...
	command.AddCommand(sub)
	tmp42 := new(StartPipelineBaseClosingTaskCommand)
	sub = &cobra.Command{
...

{
   ...
   "zone": "us-central1-f"
	...
	command.AddCommand(sub)
	tmp43 := new(StartPipelineBaseOpeningTaskCommand)
	sub = &cobra.Command{
...

{
   ...
   "zone": "us-central1-f"
	...
	tmp45 := new(WakingFinalizeTaskPipelineBaseCommand)
	sub = &cobra.Command{
...
// Run makes the HTTP request corresponding to the CreateAuthCommand command.
func (cmd *CreateAuthCommand) Run(c *client.Client, args []string) error {
	var path string
	if len(args) > 0 {
		path = args[0]
	} else {
		path = fmt.Sprintf("/admin/organizations/%v/auths", url.QueryEscape(cmd.ID))
	}
	logger := goa.NewLogger(log.New(os.Stderr, "", log.LstdFlags))
	ctx := goa.WithLogger(context.Background(), logger)
	resp, err := c.CreateAuth(ctx, path, stringFlagVal("org_id", cmd.OrgID))
	if err != nil {
		goa.LogError(ctx, "failed", "err", err)
		return err
	}
...
func (cmd *CreateAuthCommand) RegisterFlags(cc *cobra.Command, c *client.Client) {
	var id string
	cc.Flags().StringVar(&cmd.ID, "id", id, ``)
	var orgID string
	cc.Flags().StringVar(&cmd.OrgID, "org_id", orgID, ``)
}

// Run makes the HTTP request corresponding to the DeleteAuthCommand command.
func (cmd *DeleteAuthCommand) Run(c *client.Client, args []string) error {
	var path string
	if len(args) > 0 {
		path = args[0]
	} else {
		path = fmt.Sprintf("/admin/organizations/%v/auths/%v", url.QueryEscape(cmd.ID), url.QueryEscape(cmd.AuthID))
	}
	logger := goa.NewLogger(log.New(os.Stderr, "", log.LstdFlags))
	ctx := goa.WithLogger(context.Background(), logger)
	resp, err := c.DeleteAuth(ctx, path, stringFlagVal("org_id", cmd.OrgID))
	if err != nil {
		goa.LogError(ctx, "failed", "err", err)
		return err
	}
...
// RegisterFlags registers the command flags with the command line.
func (cmd *DeleteAuthCommand) RegisterFlags(cc *cobra.Command, c *client.Client) {
	var authID string
	cc.Flags().StringVar(&cmd.AuthID, "auth_id", authID, ``)
	var id string
...
// Run makes the HTTP request corresponding to the ListAuthCommand command.
func (cmd *ListAuthCommand) Run(c *client.Client, args []string) error {
	var path string
	if len(args) > 0 {
		path = args[0]
	} else {
	...
	logger := goa.NewLogger(log.New(os.Stderr, "", log.LstdFlags))
	ctx := goa.WithLogger(context.Background(), logger)
	resp, err := c.ListAuth(ctx, path, stringFlagVal("org_id", cmd.OrgID))
	if err != nil {
		goa.LogError(ctx, "failed", "err", err)
		return err
	}
...
// RegisterFlags registers the command flags with the command line.
func (cmd *ListAuthCommand) RegisterFlags(cc *cobra.Command, c *client.Client) {
	var id string
	cc.Flags().StringVar(&cmd.ID, "id", id, ``)
	var orgID string
	cc.Flags().StringVar(&cmd.OrgID, "org_id", orgID, ``)
...
// Run makes the HTTP request corresponding to the RefreshInstanceGroupConstructingTaskCommand command.
func (cmd *RefreshInstanceGroupConstructingTaskCommand) Run(c *client.Client, args []string) error {
	var path string
	if len(args) > 0 {
		path = args[0]
	} else {
	...
	logger := goa.NewLogger(log.New(os.Stderr, "", log.LstdFlags))
	ctx := goa.WithLogger(context.Background(), logger)
	resp, err := c.RefreshInstanceGroupConstructingTask(ctx, path)
	if err != nil {
		goa.LogError(ctx, "failed", "err", err)
		return err
	}
...
// RegisterFlags registers the command flags with the command line.
func (cmd *RefreshInstanceGroupConstructingTaskCommand) RegisterFlags(cc *cobra.Command, c *client.Client) {
	var id string
	cc.Flags().StringVar(&cmd.ID, "id", id, `ID`)
}
...
func (cmd *RefreshInstanceGroupDestructingTaskCommand) Run(c *client.Client, args []string) error {
	...
	logger := goa.NewLogger(log.New(os.Stderr, "", log.LstdFlags))
	ctx := goa.WithLogger(context.Background(), logger)
	resp, err := c.RefreshInstanceGroupDestructingTask(ctx, path)
	if err != nil {
		goa.LogError(ctx, "failed", "err", err)
		return err
	}
...
// RegisterFlags registers the command flags with the command line.
func (cmd *RefreshInstanceGroupDestructingTaskCommand) RegisterFlags(cc *cobra.Command, c *client.Client) {
	var id string
	cc.Flags().StringVar(&cmd.ID, "id", id, `ID`)
}
...
func (cmd *RefreshInstanceGroupResizingTaskCommand) Run(c *client.Client, args []string) error {
	...
	logger := goa.NewLogger(log.New(os.Stderr, "", log.LstdFlags))
	ctx := goa.WithLogger(context.Background(), logger)
	resp, err := c.RefreshInstanceGroupResizingTask(ctx, path)
	if err != nil {
		goa.LogError(ctx, "failed", "err", err)
		return err
	}
...
func (cmd *CreateOrganizationCommand) Run(c *client.Client, args []string) error {
	...
	var payload client.OrganizationPayload
	if cmd.Payload != "" {
		err := json.Unmarshal([]byte(cmd.Payload), &payload)
		if err != nil {
			return fmt.Errorf("failed to deserialize payload: %s", err)
...
// Run makes the HTTP request corresponding to the DeleteOrganizationCommand command.
func (cmd *DeleteOrganizationCommand) Run(c *client.Client, args []string) error {
	var path string
	if len(args) > 0 {
		path = args[0]
	} else {
		path = fmt.Sprintf("/admin/organizations/%v", url.QueryEscape(cmd.ID))
	}
	logger := goa.NewLogger(log.New(os.Stderr, "", log.LstdFlags))
	ctx := goa.WithLogger(context.Background(), logger)
	resp, err := c.DeleteOrganization(ctx, path)
	if err != nil {
		goa.LogError(ctx, "failed", "err", err)
		return err
	}
...
// RegisterFlags registers the command flags with the command line.
func (cmd *DeleteOrganizationCommand) RegisterFlags(cc *cobra.Command, c *client.Client) {
	var id string
	cc.Flags().StringVar(&cmd.ID, "id", id, `ID`)
}
...
// Run makes the HTTP request corresponding to the ShowOrganizationCommand command.
func (cmd *ShowOrganizationCommand) Run(c *client.Client, args []string) error {
	var path string
	if len(args) > 0 {
		path = args[0]
	} else {
	...
	logger := goa.NewLogger(log.New(os.Stderr, "", log.LstdFlags))
	ctx := goa.WithLogger(context.Background(), logger)
	resp, err := c.ShowOrganization(ctx, path)
	if err != nil {
		goa.LogError(ctx, "failed", "err", err)
		return err
	}
...
// RegisterFlags registers the command flags with the command line.
func (cmd *ShowOrganizationCommand) RegisterFlags(cc *cobra.Command, c *client.Client) {
	var id string
	cc.Flags().StringVar(&cmd.ID, "id", id, `ID`)
}
...
// Run makes the HTTP request corresponding to the RefreshPipelineBaseClosingTaskCommand command.
func (cmd *RefreshPipelineBaseClosingTaskCommand) Run(c *client.Client, args []string) error {
	var path string
	if len(args) > 0 {
		path = args[0]
	} else {
	...
	logger := goa.NewLogger(log.New(os.Stderr, "", log.LstdFlags))
	ctx := goa.WithLogger(context.Background(), logger)
	resp, err := c.RefreshPipelineBaseClosingTask(ctx, path)
	if err != nil {
		goa.LogError(ctx, "failed", "err", err)
		return err
	}
...
// RegisterFlags registers the command flags with the command line.
func (cmd *RefreshPipelineBaseClosingTaskCommand) RegisterFlags(cc *cobra.Command, c *client.Client) {
	var id string
	cc.Flags().StringVar(&cmd.ID, "id", id, `ID`)
}
...
func (cmd *RefreshPipelineBaseOpeningTaskCommand) Run(c *client.Client, args []string) error {
	...
	logger := goa.NewLogger(log.New(os.Stderr, "", log.LstdFlags))
	ctx := goa.WithLogger(context.Background(), logger)
	resp, err := c.RefreshPipelineBaseOpeningTask(ctx, path)
	if err != nil {
		goa.LogError(ctx, "failed", "err", err)
		return err
	}
