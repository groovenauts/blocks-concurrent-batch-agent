...
// CreateAuthContext provides the Auth create action context.
type CreateAuthContext struct {
	context.Context
	*goa.ResponseData
	*goa.RequestData
	ID    string
...
// NewCreateAuthContext parses the incoming request URL and body, performs validations and creates the
// context used by the Auth controller create action.
func NewCreateAuthContext(ctx context.Context, r *http.Request, service *goa.Service) (*CreateAuthContext, error) {
	var err error
	resp := goa.ContextResponse(ctx)
	resp.Service = service
	req := goa.ContextRequest(ctx)
	req.Request = r
	rctx := CreateAuthContext{Context: ctx, ResponseData: resp, RequestData: req}
...
func (ctx *CreateAuthContext) Created(r *AuthSecret) error {
	if ctx.ResponseData.Header().Get("Content-Type") == "" {
		ctx.ResponseData.Header().Set("Content-Type", "application/vnd.auth-secret+json")
	}
	return ctx.ResponseData.Service.Send(ctx.Context, 201, r)
}

// BadRequest sends a HTTP response with status code 400.
func (ctx *CreateAuthContext) BadRequest(r error) error {
	if ctx.ResponseData.Header().Get("Content-Type") == "" {
...
func (ctx *CreateAuthContext) Unauthorized(r error) error {
	if ctx.ResponseData.Header().Get("Content-Type") == "" {
		ctx.ResponseData.Header().Set("Content-Type", "application/vnd.goa.error")
	}
...
func (ctx *CreateAuthContext) NotFound(r error) error {
	if ctx.ResponseData.Header().Get("Content-Type") == "" {
		ctx.ResponseData.Header().Set("Content-Type", "application/vnd.goa.error")
	}
...
func (ctx *CreateAuthContext) InternalServerError(r error) error {
	if ctx.ResponseData.Header().Get("Content-Type") == "" {
		ctx.ResponseData.Header().Set("Content-Type", "application/vnd.goa.error")
	}
...
// DeleteAuthContext provides the Auth delete action context.
type DeleteAuthContext struct {
	context.Context
	*goa.ResponseData
	*goa.RequestData
	AuthID string
...
// NewDeleteAuthContext parses the incoming request URL and body, performs validations and creates the
// context used by the Auth controller delete action.
func NewDeleteAuthContext(ctx context.Context, r *http.Request, service *goa.Service) (*DeleteAuthContext, error) {
	var err error
	resp := goa.ContextResponse(ctx)
	resp.Service = service
	req := goa.ContextRequest(ctx)
	req.Request = r
	rctx := DeleteAuthContext{Context: ctx, ResponseData: resp, RequestData: req}
	paramAuthID := req.Params["auth_id"]
	if len(paramAuthID) > 0 {
		rawAuthID := paramAuthID[0]
		rctx.AuthID = rawAuthID
	}
	paramID := req.Params["id"]
	if len(paramID) > 0 {
		rawID := paramID[0]
...
func (ctx *DeleteAuthContext) OK(r *Auth) error {
	if ctx.ResponseData.Header().Get("Content-Type") == "" {
...
// BadRequest sends a HTTP response with status code 400.
func (ctx *DeleteAuthContext) BadRequest(r error) error {
	if ctx.ResponseData.Header().Get("Content-Type") == "" {
		ctx.ResponseData.Header().Set("Content-Type", "application/vnd.goa.error")
	}
	return ctx.ResponseData.Service.Send(ctx.Context, 400, r)
...
// Unauthorized sends a HTTP response with status code 401.
func (ctx *DeleteAuthContext) Unauthorized(r error) error {
	if ctx.ResponseData.Header().Get("Content-Type") == "" {
		ctx.ResponseData.Header().Set("Content-Type", "application/vnd.goa.error")
	}
	return ctx.ResponseData.Service.Send(ctx.Context, 401, r)
...
// NotFound sends a HTTP response with status code 404.
func (ctx *DeleteAuthContext) NotFound(r error) error {
	if ctx.ResponseData.Header().Get("Content-Type") == "" {
		ctx.ResponseData.Header().Set("Content-Type", "application/vnd.goa.error")
	}
	return ctx.ResponseData.Service.Send(ctx.Context, 404, r)
...
// InternalServerError sends a HTTP response with status code 500.
func (ctx *DeleteAuthContext) InternalServerError(r error) error {
	if ctx.ResponseData.Header().Get("Content-Type") == "" {
		ctx.ResponseData.Header().Set("Content-Type", "application/vnd.goa.error")
	}
	return ctx.ResponseData.Service.Send(ctx.Context, 500, r)
...
// ListAuthContext provides the Auth list action context.
type ListAuthContext struct {
	context.Context
	*goa.ResponseData
	*goa.RequestData
	ID    string
...
// NewListAuthContext parses the incoming request URL and body, performs validations and creates the
// context used by the Auth controller list action.
func NewListAuthContext(ctx context.Context, r *http.Request, service *goa.Service) (*ListAuthContext, error) {
	var err error
	resp := goa.ContextResponse(ctx)
	resp.Service = service
	req := goa.ContextRequest(ctx)
	req.Request = r
	rctx := ListAuthContext{Context: ctx, ResponseData: resp, RequestData: req}
	paramID := req.Params["id"]
	if len(paramID) > 0 {
		rawID := paramID[0]
		rctx.ID = rawID
...
// OK sends a HTTP response with status code 200.
func (ctx *ListAuthContext) OK(r AuthCollection) error {
	if ctx.ResponseData.Header().Get("Content-Type") == "" {
		ctx.ResponseData.Header().Set("Content-Type", "application/vnd.auth+json; type=collection")
	}
	if r == nil {
		r = AuthCollection{}
	}
...
// BadRequest sends a HTTP response with status code 400.
func (ctx *ListAuthContext) BadRequest(r error) error {
	if ctx.ResponseData.Header().Get("Content-Type") == "" {
		ctx.ResponseData.Header().Set("Content-Type", "application/vnd.goa.error")
	}
	return ctx.ResponseData.Service.Send(ctx.Context, 400, r)
...
// Unauthorized sends a HTTP response with status code 401.
func (ctx *ListAuthContext) Unauthorized(r error) error {
	if ctx.ResponseData.Header().Get("Content-Type") == "" {
		ctx.ResponseData.Header().Set("Content-Type", "application/vnd.goa.error")
	}
	return ctx.ResponseData.Service.Send(ctx.Context, 401, r)
...
// NotFound sends a HTTP response with status code 404.
func (ctx *ListAuthContext) NotFound(r error) error {
	if ctx.ResponseData.Header().Get("Content-Type") == "" {
		ctx.ResponseData.Header().Set("Content-Type", "application/vnd.goa.error")
	}
	return ctx.ResponseData.Service.Send(ctx.Context, 404, r)
...
// InternalServerError sends a HTTP response with status code 500.
func (ctx *ListAuthContext) InternalServerError(r error) error {
	if ctx.ResponseData.Header().Get("Content-Type") == "" {
		ctx.ResponseData.Header().Set("Content-Type", "application/vnd.goa.error")
	}
	return ctx.ResponseData.Service.Send(ctx.Context, 500, r)
...
// CreateOrganizationContext provides the Organization create action context.
type CreateOrganizationContext struct {
	context.Context
	*goa.ResponseData
	*goa.RequestData
...
// NewCreateOrganizationContext parses the incoming request URL and body, performs validations and creates the
// context used by the Organization controller create action.
func NewCreateOrganizationContext(ctx context.Context, r *http.Request, service *goa.Service) (*CreateOrganizationContext, error) {
	var err error
	resp := goa.ContextResponse(ctx)
	resp.Service = service
	req := goa.ContextRequest(ctx)
	req.Request = r
	rctx := CreateOrganizationContext{Context: ctx, ResponseData: resp, RequestData: req}
	return &rctx, err
}

// Created sends a HTTP response with status code 201.
func (ctx *CreateOrganizationContext) Created(r *Organization) error {
	if ctx.ResponseData.Header().Get("Content-Type") == "" {
		ctx.ResponseData.Header().Set("Content-Type", "application/vnd.organization+json")
	}
	return ctx.ResponseData.Service.Send(ctx.Context, 201, r)
}

// BadRequest sends a HTTP response with status code 400.
func (ctx *CreateOrganizationContext) BadRequest(r error) error {
	if ctx.ResponseData.Header().Get("Content-Type") == "" {
		ctx.ResponseData.Header().Set("Content-Type", "application/vnd.goa.error")
	}
	return ctx.ResponseData.Service.Send(ctx.Context, 400, r)
...
// Unauthorized sends a HTTP response with status code 401.
func (ctx *CreateOrganizationContext) Unauthorized(r error) error {
	if ctx.ResponseData.Header().Get("Content-Type") == "" {
		ctx.ResponseData.Header().Set("Content-Type", "application/vnd.goa.error")
	}
	return ctx.ResponseData.Service.Send(ctx.Context, 401, r)
...
// NotFound sends a HTTP response with status code 404.
func (ctx *CreateOrganizationContext) NotFound(r error) error {
	if ctx.ResponseData.Header().Get("Content-Type") == "" {
		ctx.ResponseData.Header().Set("Content-Type", "application/vnd.goa.error")
	}
	return ctx.ResponseData.Service.Send(ctx.Context, 404, r)
...
// InternalServerError sends a HTTP response with status code 500.
func (ctx *CreateOrganizationContext) InternalServerError(r error) error {
	if ctx.ResponseData.Header().Get("Content-Type") == "" {
		ctx.ResponseData.Header().Set("Content-Type", "application/vnd.goa.error")
	}
	return ctx.ResponseData.Service.Send(ctx.Context, 500, r)
...
// DeleteOrganizationContext provides the Organization delete action context.
type DeleteOrganizationContext struct {
	context.Context
	*goa.ResponseData
	*goa.RequestData
	ID string
...
// NewDeleteOrganizationContext parses the incoming request URL and body, performs validations and creates the
// context used by the Organization controller delete action.
func NewDeleteOrganizationContext(ctx context.Context, r *http.Request, service *goa.Service) (*DeleteOrganizationContext, error) {
	var err error
	resp := goa.ContextResponse(ctx)
	resp.Service = service
	req := goa.ContextRequest(ctx)
	req.Request = r
	rctx := DeleteOrganizationContext{Context: ctx, ResponseData: resp, RequestData: req}
	paramID := req.Params["id"]
	if len(paramID) > 0 {
		rawID := paramID[0]
		rctx.ID = rawID
...
// OK sends a HTTP response with status code 200.
func (ctx *DeleteOrganizationContext) OK(r *Organization) error {
	if ctx.ResponseData.Header().Get("Content-Type") == "" {
		ctx.ResponseData.Header().Set("Content-Type", "application/vnd.organization+json")
	}
	return ctx.ResponseData.Service.Send(ctx.Context, 200, r)
...
// BadRequest sends a HTTP response with status code 400.
func (ctx *DeleteOrganizationContext) BadRequest(r error) error {
	if ctx.ResponseData.Header().Get("Content-Type") == "" {
		ctx.ResponseData.Header().Set("Content-Type", "application/vnd.goa.error")
	}
	return ctx.ResponseData.Service.Send(ctx.Context, 400, r)
...
// Unauthorized sends a HTTP response with status code 401.
func (ctx *DeleteOrganizationContext) Unauthorized(r error) error {
	if ctx.ResponseData.Header().Get("Content-Type") == "" {
		ctx.ResponseData.Header().Set("Content-Type", "application/vnd.goa.error")
	}
	return ctx.ResponseData.Service.Send(ctx.Context, 401, r)
...
// NotFound sends a HTTP response with status code 404.
func (ctx *DeleteOrganizationContext) NotFound(r error) error {
	if ctx.ResponseData.Header().Get("Content-Type") == "" {
		ctx.ResponseData.Header().Set("Content-Type", "application/vnd.goa.error")
	}
	return ctx.ResponseData.Service.Send(ctx.Context, 404, r)
...
// InternalServerError sends a HTTP response with status code 500.
func (ctx *DeleteOrganizationContext) InternalServerError(r error) error {
	if ctx.ResponseData.Header().Get("Content-Type") == "" {
		ctx.ResponseData.Header().Set("Content-Type", "application/vnd.goa.error")
	}
	return ctx.ResponseData.Service.Send(ctx.Context, 500, r)
...
// ListOrganizationContext provides the Organization list action context.
type ListOrganizationContext struct {
	context.Context
	*goa.ResponseData
	*goa.RequestData
}

// NewListOrganizationContext parses the incoming request URL and body, performs validations and creates the
// context used by the Organization controller list action.
func NewListOrganizationContext(ctx context.Context, r *http.Request, service *goa.Service) (*ListOrganizationContext, error) {
	var err error
	resp := goa.ContextResponse(ctx)
	resp.Service = service
	req := goa.ContextRequest(ctx)
	req.Request = r
	rctx := ListOrganizationContext{Context: ctx, ResponseData: resp, RequestData: req}
	return &rctx, err
}

// OK sends a HTTP response with status code 200.
func (ctx *ListOrganizationContext) OK(r OrganizationCollection) error {
	if ctx.ResponseData.Header().Get("Content-Type") == "" {
		ctx.ResponseData.Header().Set("Content-Type", "application/vnd.organization+json; type=collection")
	}
	if r == nil {
		r = OrganizationCollection{}
	}
	return ctx.ResponseData.Service.Send(ctx.Context, 200, r)
}

// BadRequest sends a HTTP response with status code 400.
func (ctx *ListOrganizationContext) BadRequest(r error) error {
	if ctx.ResponseData.Header().Get("Content-Type") == "" {
		ctx.ResponseData.Header().Set("Content-Type", "application/vnd.goa.error")
	}
	return ctx.ResponseData.Service.Send(ctx.Context, 400, r)
...
// Unauthorized sends a HTTP response with status code 401.
func (ctx *ListOrganizationContext) Unauthorized(r error) error {
	if ctx.ResponseData.Header().Get("Content-Type") == "" {
		ctx.ResponseData.Header().Set("Content-Type", "application/vnd.goa.error")
	}
	return ctx.ResponseData.Service.Send(ctx.Context, 401, r)
...
// NotFound sends a HTTP response with status code 404.
func (ctx *ListOrganizationContext) NotFound(r error) error {
	if ctx.ResponseData.Header().Get("Content-Type") == "" {
		ctx.ResponseData.Header().Set("Content-Type", "application/vnd.goa.error")
	}
	return ctx.ResponseData.Service.Send(ctx.Context, 404, r)
...
// InternalServerError sends a HTTP response with status code 500.
func (ctx *ListOrganizationContext) InternalServerError(r error) error {
	if ctx.ResponseData.Header().Get("Content-Type") == "" {
		ctx.ResponseData.Header().Set("Content-Type", "application/vnd.goa.error")
	}
	return ctx.ResponseData.Service.Send(ctx.Context, 500, r)
...
// ShowOrganizationContext provides the Organization show action context.
type ShowOrganizationContext struct {
	context.Context
	*goa.ResponseData
	*goa.RequestData
	ID string
...
// NewShowOrganizationContext parses the incoming request URL and body, performs validations and creates the
// context used by the Organization controller show action.
func NewShowOrganizationContext(ctx context.Context, r *http.Request, service *goa.Service) (*ShowOrganizationContext, error) {
	var err error
	resp := goa.ContextResponse(ctx)
	resp.Service = service
	req := goa.ContextRequest(ctx)
	req.Request = r
	rctx := ShowOrganizationContext{Context: ctx, ResponseData: resp, RequestData: req}
	paramID := req.Params["id"]
	if len(paramID) > 0 {
		rawID := paramID[0]
		rctx.ID = rawID
...
// OK sends a HTTP response with status code 200.
func (ctx *ShowOrganizationContext) OK(r *Organization) error {
	if ctx.ResponseData.Header().Get("Content-Type") == "" {
		ctx.ResponseData.Header().Set("Content-Type", "application/vnd.organization+json")
	}
	return ctx.ResponseData.Service.Send(ctx.Context, 200, r)
...
// BadRequest sends a HTTP response with status code 400.
func (ctx *ShowOrganizationContext) BadRequest(r error) error {
	if ctx.ResponseData.Header().Get("Content-Type") == "" {
		ctx.ResponseData.Header().Set("Content-Type", "application/vnd.goa.error")
	}
	return ctx.ResponseData.Service.Send(ctx.Context, 400, r)
...
// Unauthorized sends a HTTP response with status code 401.
func (ctx *ShowOrganizationContext) Unauthorized(r error) error {
	if ctx.ResponseData.Header().Get("Content-Type") == "" {
		ctx.ResponseData.Header().Set("Content-Type", "application/vnd.goa.error")
	}
	return ctx.ResponseData.Service.Send(ctx.Context, 401, r)
...
// NotFound sends a HTTP response with status code 404.
func (ctx *ShowOrganizationContext) NotFound(r error) error {
	if ctx.ResponseData.Header().Get("Content-Type") == "" {
		ctx.ResponseData.Header().Set("Content-Type", "application/vnd.goa.error")
	}
	return ctx.ResponseData.Service.Send(ctx.Context, 404, r)
...
// InternalServerError sends a HTTP response with status code 500.
func (ctx *ShowOrganizationContext) InternalServerError(r error) error {
	if ctx.ResponseData.Header().Get("Content-Type") == "" {
		ctx.ResponseData.Header().Set("Content-Type", "application/vnd.goa.error")
	}
	return ctx.ResponseData.Service.Send(ctx.Context, 500, r)
