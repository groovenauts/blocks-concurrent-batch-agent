...
// StartPipelineBaseOpeningTaskBadRequest runs the method Start of the given controller with the given parameters and payload.
// It returns the response writer so it's possible to inspect the response headers and the media type struct written to the response.
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
func StartPipelineBaseOpeningTaskBadRequest(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.PipelineBaseOpeningTaskController, id *string, payload *app.OperationPayload) (http.ResponseWriter, error) {
	// Setup service
	var (
		logBuf bytes.Buffer
		resp   interface{}
	...
	goaCtx := goa.NewContext(goa.WithAction(ctx, "PipelineBaseOpeningTaskTest"), rw, req, prms)
	startCtx, __err := app.NewStartPipelineBaseOpeningTaskContext(goaCtx, req, service)
	if __err != nil {
...
// StartPipelineBaseOpeningTaskCreated runs the method Start of the given controller with the given parameters and payload.
// It returns the response writer so it's possible to inspect the response headers and the media type struct written to the response.
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
func StartPipelineBaseOpeningTaskCreated(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.PipelineBaseOpeningTaskController, id *string, payload *app.OperationPayload) (http.ResponseWriter, *app.InstanceGroupOperation) {
	// Setup service
	var (
		logBuf bytes.Buffer
		resp   interface{}
...
// StartPipelineBaseOpeningTaskInternalServerError runs the method Start of the given controller with the given parameters and payload.
// It returns the response writer so it's possible to inspect the response headers and the media type struct written to the response.
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
func StartPipelineBaseOpeningTaskInternalServerError(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.PipelineBaseOpeningTaskController, id *string, payload *app.OperationPayload) (http.ResponseWriter, error) {
	// Setup service
	var (
		logBuf bytes.Buffer
		resp   interface{}
...
// StartPipelineBaseOpeningTaskNotFound runs the method Start of the given controller with the given parameters and payload.
// It returns the response writer so it's possible to inspect the response headers and the media type struct written to the response.
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
func StartPipelineBaseOpeningTaskNotFound(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.PipelineBaseOpeningTaskController, id *string, payload *app.OperationPayload) (http.ResponseWriter, error) {
	// Setup service
	var (
		logBuf bytes.Buffer
		resp   interface{}
...
// StartPipelineBaseOpeningTaskUnauthorized runs the method Start of the given controller with the given parameters and payload.
// It returns the response writer so it's possible to inspect the response headers and the media type struct written to the response.
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
func StartPipelineBaseOpeningTaskUnauthorized(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.PipelineBaseOpeningTaskController, id *string, payload *app.OperationPayload) (http.ResponseWriter, error) {
	// Setup service
	var (
		logBuf bytes.Buffer
		resp   interface{}
