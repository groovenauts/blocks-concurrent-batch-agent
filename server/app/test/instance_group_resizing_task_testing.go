...
// StartInstanceGroupResizingTaskBadRequest runs the method Start of the given controller with the given parameters and payload.
// It returns the response writer so it's possible to inspect the response headers and the media type struct written to the response.
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
func StartInstanceGroupResizingTaskBadRequest(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.InstanceGroupResizingTaskController, id *string, payload *app.OperationPayload) (http.ResponseWriter, error) {
	// Setup service
	var (
		logBuf bytes.Buffer
		resp   interface{}
	...
	goaCtx := goa.NewContext(goa.WithAction(ctx, "InstanceGroupResizingTaskTest"), rw, req, prms)
	startCtx, __err := app.NewStartInstanceGroupResizingTaskContext(goaCtx, req, service)
	if __err != nil {
...
// StartInstanceGroupResizingTaskCreated runs the method Start of the given controller with the given parameters and payload.
// It returns the response writer so it's possible to inspect the response headers and the media type struct written to the response.
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
func StartInstanceGroupResizingTaskCreated(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.InstanceGroupResizingTaskController, id *string, payload *app.OperationPayload) (http.ResponseWriter, *app.InstanceGroupOperation) {
	// Setup service
	var (
		logBuf bytes.Buffer
		resp   interface{}
...
// StartInstanceGroupResizingTaskInternalServerError runs the method Start of the given controller with the given parameters and payload.
// It returns the response writer so it's possible to inspect the response headers and the media type struct written to the response.
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
func StartInstanceGroupResizingTaskInternalServerError(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.InstanceGroupResizingTaskController, id *string, payload *app.OperationPayload) (http.ResponseWriter, error) {
	// Setup service
	var (
		logBuf bytes.Buffer
		resp   interface{}
...
// StartInstanceGroupResizingTaskNotFound runs the method Start of the given controller with the given parameters and payload.
// It returns the response writer so it's possible to inspect the response headers and the media type struct written to the response.
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
func StartInstanceGroupResizingTaskNotFound(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.InstanceGroupResizingTaskController, id *string, payload *app.OperationPayload) (http.ResponseWriter, error) {
	// Setup service
	var (
		logBuf bytes.Buffer
		resp   interface{}
...
// StartInstanceGroupResizingTaskUnauthorized runs the method Start of the given controller with the given parameters and payload.
// It returns the response writer so it's possible to inspect the response headers and the media type struct written to the response.
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
func StartInstanceGroupResizingTaskUnauthorized(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.InstanceGroupResizingTaskController, id *string, payload *app.OperationPayload) (http.ResponseWriter, error) {
	// Setup service
	var (
		logBuf bytes.Buffer
		resp   interface{}
