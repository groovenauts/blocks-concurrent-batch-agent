...
//
// API "appengine": InstanceGroupDestructingTask TestHelpers
//
// Command:
// $ goagen
...
func RefreshInstanceGroupDestructingTaskAccepted(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.InstanceGroupDestructingTaskController, id string) (http.ResponseWriter, *app.InstanceGroupOperation) {
	...
	u := &url.URL{
		Path: fmt.Sprintf("/destructing_tasks/%v", id),
	}
...
// StartInstanceGroupDestructingTaskBadRequest runs the method Start of the given controller with the given parameters and payload.
// It returns the response writer so it's possible to inspect the response headers and the media type struct written to the response.
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
func StartInstanceGroupDestructingTaskBadRequest(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.InstanceGroupDestructingTaskController, id *string, payload *app.OperationPayload) (http.ResponseWriter, error) {
	// Setup service
	var (
		logBuf bytes.Buffer
		resp   interface{}
	...
	u := &url.URL{
		Path:     fmt.Sprintf("/destructing_tasks"),
	...
	goaCtx := goa.NewContext(goa.WithAction(ctx, "InstanceGroupDestructingTaskTest"), rw, req, prms)
	startCtx, __err := app.NewStartInstanceGroupDestructingTaskContext(goaCtx, req, service)
	if __err != nil {
...
// StartInstanceGroupDestructingTaskCreated runs the method Start of the given controller with the given parameters and payload.
// It returns the response writer so it's possible to inspect the response headers and the media type struct written to the response.
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
func StartInstanceGroupDestructingTaskCreated(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.InstanceGroupDestructingTaskController, id *string, payload *app.OperationPayload) (http.ResponseWriter, *app.InstanceGroupOperation) {
	// Setup service
	var (
		logBuf bytes.Buffer
		resp   interface{}
...
// StartInstanceGroupDestructingTaskInternalServerError runs the method Start of the given controller with the given parameters and payload.
// It returns the response writer so it's possible to inspect the response headers and the media type struct written to the response.
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
func StartInstanceGroupDestructingTaskInternalServerError(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.InstanceGroupDestructingTaskController, id *string, payload *app.OperationPayload) (http.ResponseWriter, error) {
	// Setup service
	var (
		logBuf bytes.Buffer
		resp   interface{}
...
// StartInstanceGroupDestructingTaskNotFound runs the method Start of the given controller with the given parameters and payload.
// It returns the response writer so it's possible to inspect the response headers and the media type struct written to the response.
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
func StartInstanceGroupDestructingTaskNotFound(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.InstanceGroupDestructingTaskController, id *string, payload *app.OperationPayload) (http.ResponseWriter, error) {
	// Setup service
	var (
		logBuf bytes.Buffer
		resp   interface{}
...
// StartInstanceGroupDestructingTaskUnauthorized runs the method Start of the given controller with the given parameters and payload.
// It returns the response writer so it's possible to inspect the response headers and the media type struct written to the response.
// If ctx is nil then context.Background() is used.
// If service is nil then a default service is created.
func StartInstanceGroupDestructingTaskUnauthorized(t goatest.TInterface, ctx context.Context, service *goa.Service, ctrl app.InstanceGroupDestructingTaskController, id *string, payload *app.OperationPayload) (http.ResponseWriter, error) {
	// Setup service
	var (
		logBuf bytes.Buffer
		resp   interface{}
